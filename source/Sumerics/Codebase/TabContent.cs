namespace Sumerics.Codebase
{
    ...
    public static class TabContent
    {
        ...
        public static void SetIsCached(DependencyObject obj, Boolean value)
        {
        ...
        public static readonly DependencyProperty IsCachedProperty =
            DependencyProperty.RegisterAttached("IsCached", typeof(Boolean), typeof(TabContent), new UIPropertyMetadata(false, OnIsCachedChanged));
