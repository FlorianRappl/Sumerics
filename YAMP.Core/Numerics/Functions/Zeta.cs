...
namespace YAMP.Numerics
{
    ...
    public static class Zeta
    {
        ...
        public static Complex RiemannZeta(Complex s)
        {
            if (s == 1.0)
            ...
            var sin_term = Complex.Sin(0.5 * Math.PI * s) / Math.PI;
            var sabs = s.Abs();
            ...
            else if (sabs < 170)
            {
                ...
                var p = Complex.Pow(2.0 * Math.PI, s + 10.0 * n) / Helpers.TwoPIpow[n];
                var g = Gamma.LinearGamma(1.0 - s);
                return p * g * sin_term * zeta_one_minus_s;
            }

            throw new OverflowException("The Zeta function encountered a numeric overflow.");
        }
        ...
        static Complex RiemannZetaGt0(Complex s)
        {
            if (s.Re < 1.0)
            {
            ...
            var f2 = 1.0 - Complex.Pow(2.0, -s);
            var f3 = 1.0 - Complex.Pow(3.0, -s);
            var f5 = 1.0 - Complex.Pow(5.0, -s);
            var f7 = 1.0 - Complex.Pow(7.0, -s);
        ...
        static Complex RiemannZeta1msLt0(Complex s)
        {
            if (s.Re > -19.0)
            {
                var x = (-19 - 2.0 * s) / 19.0;
            ...
            var f2 = 1.0 - Complex.Pow(2.0, -(1.0 - s));
            var f3 = 1.0 - Complex.Pow(3.0, -(1.0 - s));
            var f5 = 1.0 - Complex.Pow(5.0, -(1.0 - s));
            var f7 = 1.0 - Complex.Pow(7.0, -(1.0 - s));
            return 1.0 / (f2 * f3 * f5 * f7);
        }
