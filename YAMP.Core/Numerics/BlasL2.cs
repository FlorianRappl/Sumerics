...
namespace YAMP.Numerics
{
    ...
    public static class BlasL2
    {
        ...
        public static void cGemv(
            Complex[] aStore, int aOffset, int aRowStride, int aColStride,
            Complex[] xStore, int xOffset, int xStride,
            Complex[] yStore, int yOffset, int yStride,
            int rows, int cols
        )
        {
            int aIndex = aOffset;
