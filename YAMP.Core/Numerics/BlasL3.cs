...
namespace YAMP.Numerics
{
    ...
    public static class BlasL3
    {
        ...
        /// <param name="colsB">The coluumns to handle in the matrix B.</param>
        /// <param name="length">The columns of A / rows of B - or length for the multiplication.</param>
        public static void cGemm(Complex[] aStore, int aOffset, int aRowStride, int aColStride,
                                Complex[] bStore, int bOffset, int bRowStride, int bColStride,
                                Complex[] cStore, int cOffset, int cRowStride, int cColStride,
                                int rowsA, int colsB, int length)
        {
            int aIndex = aOffset;
            int cStart = cOffset;
