...
namespace YAMP.Numerics
{
    ...
    public static class BlasL1
    {
        ...
        public static Complex cDot(Complex[] aStore, int aOffset, int aStride, Complex[] bStore, int bOffset, int bStride, int count)
        {
            double re = 0.0;
            double im = 0.0;
            int n = 0;
        ...
        /// <param name="stride">The offset between two elements in x.</param>
        /// <param name="count">The number of elements to consider (from x).</param>
        public static void cScal(Complex alpha, Complex[] store, int offset, int stride, int count)
        {
            int n = 0;
            int i = offset;
        ...
        /// <param name="yStride">The offset between two elements in y.</param>
        /// <param name="count">The number of elements to take.</param>
        public static void cAxpy(Complex alpha, Complex[] xStore, int xOffset, int xStride, Complex[] yStore, int yOffset, int yStride, int count)
        {
            int n = 0;
            int x = xOffset;
            int y = yOffset;
